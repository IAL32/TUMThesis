    ...
    \foreach \gas in {1, 2}
        {
            \begin{subfigure}[b]{\textwidth}
                \centering
                \caption{}
                \includegraphics[height=0.335\textwidth]{./figures/06_barplot-runtime_gas-\gas_baseline-16vCPUs-GAS-1.pdf}
            \end{subfigure}%
            \hfill
        }
    ...
    \foreach \gas in {1, 2}
        {
            \begin{subfigure}[b]{0.475\textwidth}
                \centering
                \caption{}
                \includegraphics[width=\textwidth]{./figures/06_barplot-times_gas-\gas_baseline-16vCPUs-GAS-1.pdf}
            \end{subfigure}%
            \hfill
        }
    \caption{
